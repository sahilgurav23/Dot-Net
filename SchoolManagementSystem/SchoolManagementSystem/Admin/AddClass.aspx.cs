    ...
    public partial class AddClass : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                //string abc = (row.FindControl("txtClassUpdate") as TextBox).Text;


                //Response.Write("<script>alert('" + abc + "');</script>");
                //string cls = "Class Second";
                //string xyz = String.Format("Update Class set ClassName='{0}' where ClassId = {1}", cls, cId);
                //fn.Query(xyz);
